...
3) Tergetting skills that offer job security (high demand) and financial benefits (high salaries)
    offering strategic insighs for career development in data analysis
*/

-- writing query using CTEs
